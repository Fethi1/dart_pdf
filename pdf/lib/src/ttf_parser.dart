...
class TtfParser {
  ...
  void _parseGsub() {
    ...
    final int scriptListOffset = bytes.getUint16(basePosition + 4) + basePosition;
    final int featureListOffset = bytes.getUint16(basePosition + 6) + basePosition;
    final int lookupListOffset = bytes.getUint16(basePosition + 8) + basePosition;
    print(
